...
{
    public class InstagramViewsMenuItemViewModel : BaseViewModel<object>, IHeaderMenuItemViewModel
    {
        private int _selectedPostsCount;

        private const string ServiceKey = Constants.InstagramViewsServiceKey;
        ...
        public string SelectedTariffType
        {
            get
            {
                if (!IsInGradualMode)
                {
                    return Constants.InstagramViewsInstant;
                }
                else
                {
                    switch (GradualMode)
                    {
                        case GradualSpeed.Slow:
                            return Constants.InstagramViewsGradualSpeed1;
                        case GradualSpeed.Normal:
                            return Constants.InstagramViewsGradualSpeed;
                        case GradualSpeed.Fast:
                            return Constants.InstagramViewsGradualSpeed2;
                        case GradualSpeed.UltraFast:
                            return Constants.InstagramViewsGradualSpeed3;
                    }
                }
        ...
        public InstagramViewsMenuItemViewModel(IMvxNavigationService navigationService, IAnalyticsService analyticsService, MessageTokenHelper messenger,
            ...
            : base(navigationService, analyticsService, messenger, popupService)
        {
            ...
            _counter = TariffItems.First().Name;
        ...
        private void CollectOrderDataAndAddToBag(AddToBagButtonPressedMessage obj)
        {
            ...
            {
                HeaderViewModel.ExplicitlyShowError("Please select at least one post");
                return;
            }
        ...
        private bool SlowGradualSpeedAvailable
        {
            get
            {
                return _currentService.TariffTypes.First(tt => tt.Name == Constants.InstagramViewsGradualSpeed1).TariffItems.Any();
            }
        }
        ...
        private bool FastGradualSpeedAvailable
        {
            get
            {
                return _currentService.TariffTypes.First(tt => tt.Name == Constants.InstagramViewsGradualSpeed2).TariffItems.Any();
            }
        }
        ...
        private bool UltraFastGradualSpeedAvailable
        {
            get
            {
                return _currentService.TariffTypes.First(tt => tt.Name == Constants.InstagramViewsGradualSpeed3).TariffItems.Any();
            }
        }
        ...
        private bool NormalGradualSpeedAvailable
        {
            get
            {
                return _currentService.TariffTypes.First(tt => tt.Name == Constants.InstagramViewsGradualSpeed).TariffItems.Any();
            }
        }
        ...
        private bool InstantAvailable
        {
            get
            {
                return _currentService.TariffTypes.First(tt => tt.Name == Constants.InstagramViewsInstant).TariffItems.Any();
            }
        }
